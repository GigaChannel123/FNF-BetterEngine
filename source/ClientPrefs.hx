...
class ClientPrefs {
	public static var circle:Bool = false;
	...
	public static function loadPrefs() {
		if(FlxG.save.data.circle != null) {
			circle = FlxG.save.data.circle;
		}
